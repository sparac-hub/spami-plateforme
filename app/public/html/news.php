...
<div class="wrap_spa">
    ...
    <section class="wrap_content_pages">
                        ...
                        <form class="form_search row" method="post" action="" novalidate="novalidate">
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                <input type="text" name="recherche" class="input_recherche"
                                       placeholder="Rechercher actus" autocomplete="off">
                            </div>
        ...
        <div class="container container_gouvernance">
            <div class="row">
                <a href="details_news.php" class="row_gouvernance">
                    <div class="col-xs-12 col-sm-3 col-md-2 text-center content_img_gouv">
                        <img src="assets/images/jpg/news-1.jpg">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-9">
                        <div class="display_news">
                            <span class="date_desc_gouvernance"><span>Pays :</span> Tunisie / <span>Date :</span> 27 Mars 2023</span>
                            <h2 class="title_gouvernance">
                                Feuille de route pour un réseau complet et cohérent d'AMP bien gérées afin d'atteindre
                                l'Objectif 11 d'Aichi en Méditerranée
                            </h2>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-1 col-md-1">
                        <div class="icon_more_fiche">
                ...
                <a href="details_news.php" class="row_gouvernance">
                    <div class="col-xs-12 col-sm-3 col-md-2 text-center content_img_gouv">
                        <img src="assets/images/jpg/news-2.jpg">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-9">
                        <div class="display_news">
                            <span class="date_desc_gouvernance"><span>Pays :</span> Tunisie / <span>Date :</span> 27 Mars 2023</span>
                ...
                <a href="details_news.php" class="row_gouvernance">
                    <div class="col-xs-12 col-sm-3 col-md-2 text-center content_img_gouv">
                        <img src="assets/images/jpg/news-3.jpg">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-9">
                        <div class="display_news">
                            <span class="date_desc_gouvernance"><span>Pays :</span> Tunisie / <span>Date :</span> 27 Mars 2023</span>
                ...
                <a href="details_news.php" class="row_gouvernance">
                    <div class="col-xs-12 col-sm-3 col-md-2 text-center content_img_gouv">
                        <img src="assets/images/jpg/news-4.jpg">
                    </div>
                    <div class="col-xs-12 col-sm-8 col-md-9">
                        <div class="display_news">
                            <span class="date_desc_gouvernance"><span>Pays :</span> Tunisie / <span>Date :</span> 27 Mars 2023</span>
