...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify if you want your app to has multi locales or not
    | set multi locales to true and specify your locales prefixes
    |
    | If multi_locales is set to false you can specify
    | if you want a default prefix or not by setting
    | default_locale => 'langue/' or null
    |
    |
    */
    'multi_locales' => true,
    ...
    */
    ...
    'route_names' => [
        'forum_home' => 'chatter.home',
        'forum_atom' => 'chatter.atom',
        'category_show' => 'chatter.category.show',
        'discussion_index' => 'chatter.discussion.index',
        'discussion_store' => 'chatter.discussion.store',
        'discussion_create' => 'chatter.discussion.create',
        'discussion_showInCategory' => 'chatter.discussion.showInCategory',
        'discussion_email' => 'chatter.discussion.email',
        'discussion_show' => 'chatter.discussion.show',
        'discussion_destroy' => 'chatter.discussion.destroy',
        'discussion_update' => 'chatter.discussion.update',
        'discussion_edit' => 'chatter.discussion.edit',
        'forum_login' => 'chatter.login',
        'forum_register' => 'chatter.register',
        'post_store' => 'chatter.posts.store',
        'post_index' => 'chatter.posts.index',
        'post_create' => 'chatter.posts.create',
        'post_show' => 'chatter.posts.show',
        'post_update' => 'chatter.posts.update',
        'post_destroy' => 'chatter.posts.destroy',
        'post_edit' => 'chatter.posts.edit',
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | The master layout & login file for your site
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'master_file_extend' => 'front.layouts.app',
    'login_form_view' => 'auth.login_form',
    ...
    */
    ...
    'user' => [
        'namespace' => 'App\Models\Cms\GestionnaireAspim',
        'user_table_name' => 'gestionnaire_aspims',
    ...
    */
    ...
    'middleware' => [
        'global' => ['web'],
        'home' => ['CheckForumLogin'],
        'discussion' => [
            'index' => ['CheckForumLogin'],
            'show' => ['CheckForumLogin'],
            'create' => ['CheckForumLogin'],
            'store' => ['CheckForumLogin'],
            'destroy' => ['CheckForumLogin'],
            'edit' => ['CheckForumLogin'],
            'update' => ['CheckForumLogin'],
        ],
        'post' => [
            'index' => ['CheckForumLogin'],
            'show' => ['CheckForumLogin'],
