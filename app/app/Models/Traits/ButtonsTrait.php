...
trait ButtonsTrait
{
    ...
    public function getShowButtonAttribute(): string
    {
        if ($this->buttonsRouteNamePrefix) {
            if (auth()->user()->can($this->buttonsRouteNamePrefix . '.show')) {
    ...
    {
        if ($this->buttonsRouteNamePrefix) {
            if (auth()->user()->can($this->buttonsRouteNamePrefix . '.edit')) {
    ...
    {
        if ($this->buttonsRouteNamePrefix) {
            if (auth()->user()->can($this->buttonsRouteNamePrefix . '.destroy')) {
