...
<div class="content">
    ...
    <form class="login-form" action="{{ route('post-password.reset') }}" method="post">
        {{ csrf_field() }}

        <input type="hidden" name="token" value="{{ $token }}">

        <h3 class="form-title">Changer mot de passe</h3>
        ...
        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off"
                       placeholder="Adresse email" name="email" value="{{ $email or old('email') }}"/></div>
            @if ($errors->has('email'))
        ...
        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <div class="input-icon">
                <i class="fa fa-lock"></i>
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                       placeholder="Confirmation ot de passe" name="password_confirmation"/></div>
        ...
        <div class="form-actions">
            <label> </label>
            <button type="submit" class="btn green pull-right"> Changer mot de passe</button>
        </div>
    </form>
