...
<div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
        <div class="panel-heading">
            <h1 class="panel-title">{{ __('laravel-filemanager::lfm.title-panel') }}</h1>
        </div>
    </div>
    <div class="row">
            ...
            <nav class="navbar navbar-default" id="nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand clickable hide" id="to-previous">
                        ...
                        <span class="hidden-xs">{{ __('laravel-filemanager::lfm.nav-back') }}</span>
                    </a>
                    <a class="navbar-brand visible-xs" href="#">{{ __('laravel-filemanager::lfm.title-panel') }}</a>
                </div>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false">
                                {{ __('laravel-filemanager::lfm.nav-sort') }} <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="#" id="list-sort-alphabetic">
                                        <i class="fa fa-sort-alpha-asc"></i> {{ __('laravel-filemanager::lfm.nav-sort-alphabetic') }}
                                    </a>
                                </li>
                                <li>
                                    <a href="#" id="list-sort-time">
                                        <i class="fa fa-sort-amount-asc"></i> {{ __('laravel-filemanager::lfm.nav-sort-time') }}
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <ul id="fab">
            <li>
                ...
                <ul class="hide">
                    <li>
                        <a href="#" id="add-folder" data-mfb-label="{{ __('laravel-filemanager::lfm.nav-new') }}">
                            <i class="fa fa-folder"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="upload" data-mfb-label="{{ __('laravel-filemanager::lfm.nav-upload') }}">
        ...
        <div class="modal-content">
                        ...
                        <div class="controls text-center">
                            <div class="input-group" style="width: 100%">
                                <a class="btn btn-primary"
                                   id="upload-button">{{ __('laravel-filemanager::lfm.message-choose') }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                        data-dismiss="modal">{{ __('laravel-filemanager::lfm.btn-close') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    var route_prefix = "{{ route('front.home') }}";
...
<script>
    ...
    $('#fab').fab({
        buttons: [
            {
                icon: 'fa fa-folder',
                label: "{{ __('laravel-filemanager::lfm.nav-new') }}",
                attrs: {id: 'add-folder'}
            },
            {
                icon: 'fa fa-upload',
                label: "{{ __('laravel-filemanager::lfm.nav-upload') }}",
                attrs: {id: 'upload'}
            }
        ]
    });
