...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.plan_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.plan_categories.create'), false) !!}

    @include('back._common.alerts.messages')

    <form action="{{ route('back.plan_categories.store') }}" method="post" class="form-create">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="icheck-inline">
                    ...
                    <label>
                        <input type="radio" name="is_active" value="0" @if(old('is_active')==0) checked @endif checked
