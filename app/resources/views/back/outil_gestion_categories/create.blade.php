...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.outil_gestion_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.outil_gestion_categories.create'), false) !!}

    @include('_common.alerts.messages')

    <form action="{{ route('back.outil_gestion_categories.store') }}" method="post" class="form-create">
