...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.media_album_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.media_album_categories.create'), false) !!}

    @include('_common.alerts.messages')

    <form action="{{ route('back.media_album_categories.store') }}" method="post" class="form-create">
