...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.procedure_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.procedure_categories.create'), false) !!}

    @include('back._common.alerts.messages')

    <form action="{{ route('back.procedure_categories.store') }}" method="post" class="form-create">
