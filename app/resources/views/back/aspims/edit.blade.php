...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.aspims.edit', $aspim->menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.aspims.edit'), false) !!}

    @include('_common.alerts.messages')

    <form action="{{ route('back.aspims.update', $aspim->id) }}" method="post"
        ...
        <div class="row">
                ...
                <div class="bhoechie-tab-content active">
                                ...
                                <div class="tab-pane @if($k==0) active @endif" id="tab_1_{{$locale}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="{{$locale}}[name]"
                                               id="name_{{ $locale }}"
                                               value="{{ old($locale.'.name', $aspim->translateOrNew($locale)->name) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="{{$locale}}[slug]"
                                               id="slug_{{ $locale }}"
                                               value="{{ old($locale.'.slug', $aspim->translateOrNew($locale)->slug) }}">
                                    </div>

                                    <div class="form-group">
                                        <label>{{__('og.aspim_translations.status')}} *</label>
                                        <input type="text" class="form-control" name="{{$locale}}[status]"
                                               value="{{ old($locale.'.status', $aspim->translateOrNew($locale)->status) }}"
                                               id="status_{{ $locale }}"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="{{$locale}}[creation_text]"
                                               value="{{ old($locale.'.creation_text', $aspim->translateOrNew($locale)->creation_text) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  name="{{$locale}}[schemas]"
                                                  rows="10">{{ old($locale.'.schemas', $aspim->translateOrNew($locale)->schemas) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.physical_features', $aspim->translateOrNew($locale)->physical_features) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.ecological_features', $aspim->translateOrNew($locale)->ecological_features) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.threats_and_pressures', $aspim->translateOrNew($locale)->threats_and_pressures) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.teritory', $aspim->translateOrNew($locale)->teritory) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.mediterranean_importance', $aspim->translateOrNew($locale)->mediterranean_importance) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.management_body', $aspim->translateOrNew($locale)->management_body) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" class="form-control"
                                                  ...
                                                  rows="10">{{ old($locale.'.geographic_position', $aspim->translateOrNew($locale)->geographic_position) }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label>{{__('og.aspim_translations.meta_title')}} </label>
                                        <input type="text" class="form-control" name="{{$locale}}[meta_title]"
                                               value="{{ old($locale.'.meta_title', $aspim->translateOrNew($locale)->meta_title) }}">
                                    </div>

                                    <div class="form-group">
                                        <label>{{__('og.aspim_translations.meta_description')}} </label>
                                        <textarea class="form-control" name="{{$locale}}[meta_description]"
                                                  rows="3">{{ old($locale.'.meta_description', $aspim->translateOrNew($locale)->meta_description) }}</textarea>
                                    </div>
                            ...
                            <div class="icheck-inline">
                                <label>
                                    <input type="radio" name="is_active" value="1"
                                           @if(old('is_active',$aspim->is_active)) checked @endif
                            ...
                            @if($countries)
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}"
                                            @if(old('countries') == $country->id || in_array($country->id, $selected_countries)) selected @endif
                                    >{{ $country->name }}</option>
                                @endforeach
                            @endif
                        </select>
                            ...
                            @if($aspim_categories)
                                @foreach ($aspim_categories as $aspim_category)
                                    <option value="{{ $aspim_category->id }}"
                                            {{ (old('aspim_category_id') == $aspim_category->id || $aspim_category->id == $aspim->aspim_category_id)?'selected':'' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="creation_date" name="creation_date"
                               value="{{ old('creation_date',$aspim->creation_date) }}">
                    </div>

                    <div class="form-group">
                        @if (!$aspim->getMedia('document')->isEmpty())
                            <label for="link">Upload document
                                File: {{ $aspim->getMedia('document')->first()->file_name }}</label>
                        @endif
                    ...
                    <div class="form-group">
                        @if (!$aspim->getMedia()->isEmpty())
                            <label for="link">Upload Publication
                                File: {{ $aspim->getMedia()->first()->file_name }}</label>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="gallery[]"
                               accept="image/*,video/mp4,video/x-m4v,video/*" multiple>
                    </div>
                        ...
                        <select class="form-control" name="mapamed_feature_id">
                            ...
                            @if($aspim_mapamed_features)
                                @foreach ($aspim_mapamed_features as $key => $value)
                                    <option value="{{ $value }}"
                                            @if(old('mapamed_feature_id', $aspim->mapamed_feature_id) == $value) selected @endif
                                    >{{ $key }}</option>
                                @endforeach
                            @endif
                        </select>
            ...
            <div class="col-md-12">
                <button type="submit" class="pull-right btn btn-primary">{{__('og.button.save')}}</button>
            </div>
        </div>
    </form>
...
@section('js')
    ...
    <script>
        ...
        var zoomIn = 8;
        var featureId = '{{old('mapamed_feature_id', $aspim->mapamed_feature_id)}}';
