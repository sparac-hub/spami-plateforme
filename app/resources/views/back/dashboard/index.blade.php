...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.admin') }}
@endsection

@section('content')

    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ __('breadcrumbs.back.admin') }}
        <small></small>
    </h1>
    <!-- END PAGE TITLE-->
    ...
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$contact_messages_number}}"></span></div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 green-meadow" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$active_pages_number}}"></span></div>
                    <div class="desc"> Active Pages</div>
                </div>
            </a>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue-chambray" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$active_users_number}}"></span></div>
