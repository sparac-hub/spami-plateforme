...
@section('content')
    ...
    {!! set_box_head(__('og.box_title.list').'Languages', false) !!}

    @include('back._common.alerts.messages')


    <input type="checkbox" class="toggle-vis" data-column="id" checked/> {{__('og.languages.id')}} |
    ...
    <script>
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('back.languages.datatables') !!}',
                columns: [
                    {data: 'id', name: 'id'},
                    {{--
