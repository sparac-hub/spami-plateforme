...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.testimonial_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.testimonial_categories.create'), false) !!}

    @include('_common.alerts.messages')

    <form action="{{ route('back.testimonial_categories.store') }}" method="post" class="form-create">
