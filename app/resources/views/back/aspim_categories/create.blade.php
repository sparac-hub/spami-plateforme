...
@section('breadcrumbs')
    {{ Breadcrumbs::render('back.aspim_categories.create', $menu_id) }}
@endsection

@section('content')

    {!! set_box_head(__('breadcrumbs.back.aspim_categories.create'), false) !!}

    @include('_common.alerts.messages')

    <form action="{{ route('back.aspim_categories.store') }}" method="post" class="form-create">
