...
class ModulePlansTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $data = [
            [
                'name' => 'Plans',
                'reference' => 'plans',
                'main_model' => 'App\Models\Cms\Plan',
                'is_active' => 1,
                'is_menu_module' => true,
                'order' => 50,
                'icon' => '',
                'backend_route' => 'back.plans.index',
                'backend_controller' => 'Plans',
                'backend_action' => 'index',
                'except_backend_actions' => null,
                'only_backend_actions' => null,
                'frontend_route' => 'back.plan.index',
                'front_namespace' => 'Front',
                'front_controller' => 'PlansController',
