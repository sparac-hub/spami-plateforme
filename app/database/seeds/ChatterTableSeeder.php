...
class ChatterTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!\DB::table(config('chatter.user.user_table_name'))->find(1)) {
            \DB::table(config('chatter.user.user_table_name'))->insert([
                0 => [
                    'id' => 1,
                    'name' => 'Tony Lea',
                    'surname' => 'Tony Lea',
        ...
        \DB::table('chatter_post')->insert([
            0 => [
                ...
                'user_id' => 1,
                'body' => '<p>My name is Tony and I\'m a developer at <a href="https://www.medianet.tn/fr/" target="_blank">https://www.medianet.tn/fr/</a> and I also work with an awesome company in PB called The Control Group: <a href="http://www.thecontrolgroup.com" target="_blank">http://www.thecontrolgroup.com</a></p>
        ...
        <p>You\'ll probably want to delete this user, but if for some reason you want to keep it... Go ahead :)</p>',
            ...
            2 => [
                ...
                'user_id' => 1,
                'body' => '<p>If you would like to leave some feedback or have any issues be sure to visit the github page here: <a href="https://github.com/medianet-dev/forum" target="_blank">https://github.com/medianet-dev/forum</a>&nbsp;and I\'m sure I can help out.</p>
        ...
        <p><span style="line-height: 1.6;">Post links: <a href="https://www.medianet.tn/fr/" target="_blank">https://www.medianet.tn/fr/</a></span></p>
        ...
        <p><img src="https://media.giphy.com/media/XNdoIMwndQfqE/200.gif" alt="" width="200" height="200" /></p>',
            ...
            5 => [
                ...
                'user_id' => 1,
                'body' => '<p>Hey There!</p>
        <p>My name is Tony and I\'m the creator of this package that you\'ve just installed. Thanks for checking out it out and if you have any questions or want to contribute be sure to checkout the repo here: <a href="https://github.com/medianet-dev/forum" target="_blank">https://github.com/medianet-dev/forum</a></p>
